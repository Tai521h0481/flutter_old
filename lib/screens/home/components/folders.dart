...
class _PopularProductsState extends State<Folders> {
  ...
  Future<void> loadFolder() async {
    ...
    if (storedFolders != null && !LocalStorageService().isFirstTime) {
      setState(() {
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: List.generate(
              ...
              //   },
              // ),
              (index) => SpecialFolderFactory.createList(filteredFolders: filteredFolders[index], context: context, image: image, name: name, isLarge: false),
            ),
          ),
        ),
      ],
